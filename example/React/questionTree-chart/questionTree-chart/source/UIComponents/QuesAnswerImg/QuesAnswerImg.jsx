...
class QuesAnswerImg extends Component {
    ...
    initData() {
        ...
        let filter_answer = this.state.chooses
        ...
        this.setState({answersMap: answersMapCopy, chooses: filter_answer, orientation})
    } 
    ...
    clickAnswerFunc(answer) {
        ...
        if (question.question.type === 2) {
            ...
            this.setState({chooses: filter_chooses})
            return
        } else {
                    ...
                    <QueueAnim  
                        animConfig={[
                            ...
                            {answersMap.map(function (answerList, listIndex) {
                                return (
                                    <div className='gt-flex' key={listIndex}>
