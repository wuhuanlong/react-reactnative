...
import {KgetData_allQuestion, KgetNextQuestion, KgetBeforeQuestion,
    KresetQuestion, KallQuestionDone,
...
export const QuestionTreeReducer = (state = init_currentStep, action = {}) => {
    switch (action.type) {
        ...
        case KgetData_allQuestion: {
            ...
            //     break
            // }
            newState.currentQuestion = [action.totalQuestion[newState.currentStep - 1]]
                ...
                if(choosedAnswers.length === 1){
                    ...
                    if(sel_answer.order !== 1 && sel_answer.order !== 2){
                        ...
                        if(nextQuestions){
                            ...
                            state.currentQuestion = [nextQuestions]
            ...
            if(clickQuestion.question.series) {
                if(choosedAnswers[0].order !== 2){
                    ...
                    while(state.currentStep <= state.totalStep){
                        ...
                        state.currentQuestion = [state.totalQuestion[curStepCopy-1]]
                        break
                    }
                }
            }else {
                // 如果是单选题或者多选题，则直接下一题
                state.currentStep ++
                state.currentQuestion = [state.totalQuestion[state.currentStep-1]]
            }
